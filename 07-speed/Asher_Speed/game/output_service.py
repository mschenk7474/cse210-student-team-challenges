...
class OutputService:
    ...
    def draw_text(self, text, is_dark_text):
        """
        ...
        raylibpy.draw_text(text,
            random.randint(1, 600) + constants.DEFAULT_TEXT_OFFSET,
            random.randint(1, 400)+ constants.DEFAULT_TEXT_OFFSET,
